...
public class BarcodeUtils {
    ...
    public static List<Map<String, Object>> serializeResult(BarcodeDetectorResult result) {
        final List<Map<String, Object>> barcodes = new ArrayList<>(result.getBarcodes().size());

        for (final FirebaseVisionBarcode barcode : result.getBarcodes()) {
            final Map<String, Object> barcodeMap = new HashMap<>();
