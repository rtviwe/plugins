...
@implementation BarcodeDetectorResult {
    NSArray<FIRVisionBarcode *> *_barcodes;
}
...
- (NSArray *)asSerialized {
    ...
    for (FIRVisionBarcode *barcode in _barcodes) {
        [result addObject:visionBarcodeToDictionary(barcode)];
    }
    return result;
}
